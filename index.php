       ...
       <main>
            <div class="left-side">
                ...
                <div class="tour-wrapper" id='cont'>
                    <a href="#"><img src="<?php echo$img1?>" class="tour_demo"></a>
                    <a href="#"><img src="<?php echo$img2?>" class="tour_demo"></a>
                    <a href="#"><img src="<?php echo$img3?>" class="tour_demo"></a>
        ...
        <div class="promo">
            <iframe src="https://drive.google.com/file/d/1882KtXhrmh0VE6uusJdZRGe8pVrEoHDs/preview" autoplay></iframe>

           <!--< <video autoplay muted loop>
                <source src="videos/promo_vid.mp4" type="video/mp4"> //we remove the video because uploading size
            </video>-->
        </div>  
